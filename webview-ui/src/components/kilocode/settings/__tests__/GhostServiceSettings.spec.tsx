...
// Create a reference to CollapsibleTrigger for the mock to use
const CollapsibleTrigger = (props: any) => (
	<button data-testid="collapsible-trigger" onClick={props.onClick}>
		{props.children}
	</button>
)
...
const defaultGhostServiceSettings = {
