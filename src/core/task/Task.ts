...
import { makeRequest } from "./kilocode-request"
...
export class Task extends EventEmitter<TaskEvents> {
	...
	private async initiateTaskLoop(userContent: Anthropic.Messages.ContentBlockParam[]): Promise<void> {
		...
		while (!this.abort) {
			...
			const didEndLoop = await makeRequest(this, nextUserContent, includeFileDetails) // kilocode_change use non recursive version
