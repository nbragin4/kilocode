...
export class CodeIndexOllamaEmbedder implements IEmbedder {
	...
	private readonly embedderTimeoutMS: number // kilocode_change
	...
	constructor(options: ApiHandlerOptions) {
		...
		this.embedderTimeoutMS = options?.codebaseIndexEmbedderTimeoutMS || OLLAMA_EMBEDDING_TIMEOUT_MS // kilocode_change
	...
	async createEmbeddings(texts: string[], model?: string): Promise<EmbeddingResponse> {
		...
		try {
			...
			const timeoutId = setTimeout(() => controller.abort(), this.embedderTimeoutMS) // kilocode_change
